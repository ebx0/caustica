...
CEM43 dose and ITRUSST threshold summary of one Pennes solve (`caustica-thermal/1`), generated 2026-08-23T12:09:53+00:00.
...
|---|---|
| baseline [°C] | 37 |
| peak over the whole history [°C] | 54.94 |
| peak rise ΔT [°C] | 17.94 |
...
|  |  |
|---|---|
| peak CEM43 [equivalent minutes] | 475.5 |
...
|---|---|---|---|---|
| CEM43 (brain) | 2 equivalent minutes at 43 C | 54.9 mm³ (962 vox) | 0.939% | EXCEEDED |
| CEM43 (bone) | 16 equivalent minutes at 43 C | 14.1 mm³ (247 vox) | 0.241% | EXCEEDED |
| CEM43 (skin) | 21 equivalent minutes at 43 C | 10.67 mm³ (187 vox) | 0.183% | EXCEEDED |
| temperature rise (non-thermal line) | 2 C | 1158 mm³ (20295 vox) | 19.8% | EXCEEDED |
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | Skin | skin | 182.6 mm³ (3200 vox) | 47.76 | 10.76 | 4.14 | 21 | 0 | PASS |
| 2 | Brain | brain | 5661 mm³ (99200 vox) | 54.94 | 17.94 | 475.5 | 2 | 913 | EXCEEDED |
...
|  |  |
|---|---|
| caustica | 0.1.0.dev0 @ 7a3780067427 |
| host | LOQ |
...
- acoustics: westervelt on (56, 56, 80) at 0.385 mm (270 steps, converged period 28); peak |p| = 1.946 MPa in the recorded interior.
- heating: f0_only at harmonics (1,) (the second harmonic WAS recorded and deliberately not heated — the M18 honesty contract); Q_max = 1.873e+07 W/m^3, 1090 mW absorbed in the region.
