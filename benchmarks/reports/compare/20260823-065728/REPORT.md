...
**Overall verdict: PASS** (`caustica-compare/1`, generated 2026-08-23T06:57:28+00:00)
...
| | |
|---|---|
| job | compare-mini (`builtin:compare-mini`) |
| grid | [48, 48, 60] @ 0.5 mm, PML 10 vox |
| reference solver | `linear` |
| backend | numpy (requested `auto`) |
| host | LOQ |
| caustica | 0.1.0.dev0 @ bddb019f1e9ad61eb818b597cbcde2e92ae5b823 |
| python / numpy | 3.12.10 / 2.2.6 |
| platform | Windows-11-10.0.26200-SP0 |
| suite runtime | 10.71 s |
...
|---|---|---|---|---|---|---|
| `linear` | ok | 0.3014 | 0.7115 | 120 | 0.6171 | -- |
| `kwave` | ok | 7.433 | 1.388 | 220 | 0.59 | -- |
| `westervelt` | ok | 0.2459 | 0.5401 | 120 | 0.6171 | -- |
...
|---|---|---|---|---|---|
| linear vs kwave | 0.02857 | 0.9992 | 0 | 0.9561 | 20736 |
| linear vs westervelt | 0 | 1 | 0 | 1 | 20736 |
...
|---|---|---|---|---|---|---|---|---|
| `linear` | 0.6171 | [24, 24, 26] | 7 | 11.2 | 2.641 | 2.639 | 50.25 | 12.7 |
| `kwave` | 0.59 | [24, 24, 26] | 7 | 11.09 | 2.642 | 2.638 | 51.75 | 11.6 |
| `westervelt` | 0.6171 | [24, 24, 26] | 7 | 11.2 | 2.641 | 2.639 | 50.25 | 12.7 |
...
| t0.linear.peak | PASS | 1.4524 x analytic (band 0.2..5 x analytic) | tests/test_linear_oneill_3d.py::test_axial_profile_matches_oneill (via caustica.analytic.oneill.focal_gain) |
...
| t0.westervelt.peak | PASS | 1.4524 x analytic (band 0.2..5 x analytic) | tests/test_linear_oneill_3d.py::test_axial_profile_matches_oneill (via caustica.analytic.oneill.focal_gain) |
...
| check | verdict | measured vs limit | source of the tolerance |
|---|---|---|---|
| linear-vs-kwave.corr | PASS | 0.999236 (floor 0.99) | tests/test_kwave_adapter.py::test_kwave_vs_linear_2d_water |
...
Reproduce: `python -m caustica.validation compare --solvers linear,kwave,westervelt --backend auto`. The job that was actually built is stored beside this file as `job_input.json`.
