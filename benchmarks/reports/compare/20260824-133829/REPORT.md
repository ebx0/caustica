...
**Overall verdict: PASS** (`caustica-compare/1`, generated 2026-08-24T13:38:29+00:00)
...
|---|---|---|---|---|---|---|
| `linear` | ok | 0.4086 | 0.9889 | 120 | 0.5229 | -- |
| `kwave` | ok | 84.39 | 76.94 | 220 | 0.5 | -- |
| `westervelt` | ok | 0.3873 | 0.9299 | 120 | 0.5229 | -- |
...
|---|---|---|---|---|---|
| linear vs kwave | 0.02769 | 0.9993 | 0 | 0.956 | 20736 |
...
|---|---|---|---|---|---|---|---|---|
| `linear` | 0.5229 | [24, 24, 26] | 7 | 11.39 | 2.741 | 2.742 | 53.38 | 9.1 |
| `kwave` | 0.5 | [24, 24, 26] | 7 | 11.33 | 2.739 | 2.741 | 56.88 | 8.3 |
| `westervelt` | 0.5229 | [24, 24, 26] | 7 | 11.39 | 2.741 | 2.742 | 53.38 | 9.1 |
...
| check | verdict | measured vs limit | source of the tolerance |
|---|---|---|---|
| linear-vs-kwave.corr | PASS | 0.999307 (floor 0.99) | tests/test_kwave_adapter.py::test_kwave_vs_linear_2d_water |
