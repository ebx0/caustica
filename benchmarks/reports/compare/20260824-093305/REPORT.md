...
**Overall verdict: PASS** (`caustica-compare/1`, generated 2026-08-24T09:33:05+00:00)
...
| backend | numpy (requested `numpy`) |
| host | LOQ |
| caustica | 0.1.0.dev0 @ 217d21ea434d45be36c2fce03928a8dabe2f5b95 |
| python / numpy | 3.12.10 / 2.2.6 |
| platform | Windows-11-10.0.26200-SP0 |
| suite runtime | 14.46 s |
...
|---|---|---|---|---|---|---|
| `linear` | ok | 0.2665 | 0.6235 | 120 | 0.6172 | -- |
| `kwave` | ok | 6.567 | 4.754 | 220 | 0.59 | -- |
| `westervelt` | ok | 0.3481 | 0.8075 | 120 | 0.6172 | -- |
...
|---|---|---|---|---|---|
| linear vs kwave | 0.02987 | 0.9991 | 0 | 0.9561 | 20736 |
...
|---|---|---|---|---|---|---|---|---|
| `linear` | 0.6172 | [24, 24, 26] | 7 | 11.2 | 2.642 | 2.64 | 50 | 12.7 |
| `kwave` | 0.59 | [24, 24, 26] | 7 | 11.09 | 2.642 | 2.638 | 51.75 | 11.6 |
| `westervelt` | 0.6172 | [24, 24, 26] | 7 | 11.2 | 2.642 | 2.64 | 50 | 12.7 |
...
| check | verdict | measured vs limit | source of the tolerance |
|---|---|---|---|
| linear-vs-kwave.corr | PASS | 0.999143 (floor 0.99) | tests/test_kwave_adapter.py::test_kwave_vs_linear_2d_water |
...
Reproduce: `python -m caustica.validation compare --solvers linear,kwave,westervelt --backend numpy`. The job that was actually built is stored beside this file as `job_input.json`.
