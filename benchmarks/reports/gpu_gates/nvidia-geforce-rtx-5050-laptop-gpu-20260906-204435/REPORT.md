...
**Overall verdict: INCOMPLETE** (`caustica-gpu-gates/1`, generated 2026-09-06T20:44:35+00:00)
...
| `time` | **PASS** | post-calibration wall-time prediction within +/-25% of actual, on at least 2 scenarios (same device); a plan whose source is not 'calibrated' does not count |
...
| vram-1.587gib-250: wall time | PASS | predicted 7.6 s vs actual 7.96 s (-4.5%, tolerance +/-25%) |
| vram-3.809gib-324: wall time | PASS | predicted 28.3 s vs actual 23.4 s (+20.9%, tolerance +/-25%) |
...
|---|---|---|---|---|---|---|---|---|
| vram-1.587gib-250 | 250x250x250 | 1.544 GiB | 1.431 GiB | +7.9% | 7.6 s | 7.96 s | -4.5% | 0 |
| vram-3.809gib-324 | 324x324x324 | 3.359 GiB | 3.113 GiB | +7.9% | 28.3 s | 23.4 s | +20.9% | 0 |
| oom-432 | 432x432x432 | 7.957 GiB | -- GiB | -- | 116.8 s | -- s | -- | 3 |

## Step-time baseline

| shape | voxels | steady s/step | measured s/step (incl. warmup) | warmup s |
|---|---|---|---|---|
| 250x250x250 | 15,625,000 | 0.02655 | 0.03063 | 1.061 |
| 324x324x324 | 34,012,224 | 0.06642 | 0.07312 | 2.142 |
