...
grid sizes and persists the coefficients to ``~/.hifusim/calibration.json``
...
from hifusim.planner.model import fft_sizes
from hifusim.solvers.kspace import operators as ops


def default_calibration_path() -> Path:
    return Path.home() / ".hifusim" / "calibration.json"
...
def calibrate(
    ...
    *,
    ...
    :func:`hifusim.planner.estimate` picks it up automatically when the
